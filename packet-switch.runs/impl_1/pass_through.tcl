...
namespace eval ::optrace {
  variable script "D:/Data/HLS/packet-switch/packet-switch.runs/impl_1/pass_through.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/Data/HLS/packet-switch/packet-switch.cache/wt [current_project]
  set_property parent.project_path D:/Data/HLS/packet-switch/packet-switch.xpr [current_project]
  set_property ip_output_repo D:/Data/HLS/packet-switch/packet-switch.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/Data/HLS/packet-switch/packet-switch.runs/synth_1/pass_through.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc D:/Data/HLS/packet-switch/packet-switch.srcs/constrs_1/new/basys3.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top pass_through -part xc7a35tcpg236-1 
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force pass_through_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file pass_through_timing_summary_routed.rpt -pb pass_through_timing_summary_routed.pb -rpx pass_through_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file pass_through_bus_skew_routed.rpt -pb pass_through_bus_skew_routed.pb -rpx pass_through_bus_skew_routed.rpx"
