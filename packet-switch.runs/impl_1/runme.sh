...
HD_PWD='D:/Data/HLS/packet-switch/packet-switch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pass_through.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pass_through.tcl -notrace
