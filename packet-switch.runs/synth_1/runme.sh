...
HD_PWD='D:/Data/HLS/packet-switch/packet-switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pass_through.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pass_through.tcl
